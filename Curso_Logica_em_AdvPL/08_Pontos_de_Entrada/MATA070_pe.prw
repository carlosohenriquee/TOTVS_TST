...
Ponto de entrada MVC no cadastro de Bancos
@author Carlos Henrique
@since 23/09/2024
@version 1.0
@return xRet, Retorno Variável dependendo do Ponto
@type function
@obs Ao criar um P.E. em MVC com o mesmo nome do ModelDef, deixe o nome do prw com outro nome, por exemplo, MATAXXX_pe.prw
